                        ...
                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td style="padding:0 35px;">
                                    ...
                                    <a href="{{ env("APP_URL") }}/order/prestation-accepted/{{ $data['order_id'] }}" style="background:#50BFDF;text-decoration:none !important; font-weight:500; margin-top:35px; color:#ffffff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">
